    ...
    <div className="space-y-3 w-full">
      ...
      {taskQueue.length === 0 ? (
        <div className="bg-white rounded-md shadow-sm border border-gray-200 p-6 text-center">
          ...
          <p style={{ fontWeight: 600, fontSize: "22px", color: "#858484" }}>
            No pending tasks
          </p>
        </div>
      ) : (
          ...
          <div className="bg-white rounded-xl shadow-lg p-6 border border-gray-100">
            ...
            <div className="mb-4">
              <p className="text-sm text-gray-600">
                {taskQueue.length} task{taskQueue.length !== 1 ? "s" : ""}{" "}
                pending
              </p>
            </div>
    ...
    <div className="bg-white rounded-xl shadow p-6 border border-gray-100">
      ...
      <div className="flex gap-3">
        <button
          ...
          onMouseEnter={(e) =>
            (e.currentTarget.style.backgroundColor = "#f3f2fb")
          }
...
function LeftSidebar({ currentTask, taskQueue, currentState }) {
  ...
  const getActiveTab = () => {
    ...
    if (
      ...
      currentTask?.inputData?.ui_component === "BankReviewInfoScreen"
    ) {
      return "review";
    } else if (
      currentState === "rendering" &&
  ...
  return (
    <div
      className="w-64 rounded-xl shadow border border-gray-100 p-4 my-8 ml-4"
